...
export default function TrendingProduct() {
  ...
  if (error) {
    return <p className="p-4 text-red-500">Error loading trending products</p>;
  }

  return (
    <div className="container bg-white rounded-lg m-4">
      <div className="flex justify-between border-b-2">
        <p className="text-2xl font-bold m-2">Trending products</p>
        <p className="hover:text-purple-600 font-bold cursor-pointer">see more</p>
      </div>
      <Carousel>
        <CarouselContent>
