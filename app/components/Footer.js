...
export default function Footer() {
  return (
    <footer className="bg-gray-100 text-gray-700 pt-12 pb-8 px-10 tracking-wide">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Useful Links */}
          <div>
            <h4 className="text-base mb-4 text-gray-900 font-semibold">Useful links</h4>
          ...
          {/* Information */}
          <div>
            <h4 className="text-base mb-4 text-gray-900 font-semibold">Information</h4>
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-600 hover:text-gray-900 text-sm">
                  About Us
